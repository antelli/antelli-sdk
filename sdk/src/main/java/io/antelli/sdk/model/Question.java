...
public class Question implements Parcelable {
    ...
    public int getWordPosition(@NonNull String word) {
        String[] words = getWords();
    ...
    private void setQuery(@NonNull String lowerCase) {
    ...
    public void setParam(@NonNull String name, @NonNull String value) {
    ...
    private String addSpacePadding(@NonNull String string) {
        return " " + string + " ";
    }
